...
public class API_InputSystem_Bluetooth {
    ...
    public static int[] GetAcc(BTType type = BTType.Right) {
        ...
        if(BTDevice && type == BTType.Right) {
            return BTRight.inputDataGetHandShank.inputDataGetHandShankIMU.GetAcc();
        } else if(BTDevice && type == BTType.Left) {
            return BTLeft.inputDataGetHandShank.inputDataGetHandShankIMU.GetAcc();
        }
        return temp;
    }
    ...
    public static int[] GetGyro(BTType type = BTType.Right) {
        if(BTDevice && type == BTType.Right) {
            return BTRight.inputDataGetHandShank.inputDataGetHandShankIMU.GetGyro();
        } else if(BTDevice && type == BTType.Left) {
            return BTLeft.inputDataGetHandShank.inputDataGetHandShankIMU.GetGyro();
        }
        return temp;
    }
